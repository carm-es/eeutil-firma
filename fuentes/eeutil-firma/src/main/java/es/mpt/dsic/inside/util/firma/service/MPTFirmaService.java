...
/**
 * Interfaz de negocio para eeutil-firma.
 * 
 * @author miguel.moral
 *
 */
public interface MPTFirmaService {
  ...
  /**
   * Metodo para firmar fichero.
   * 
   * @param aplicacion aplicacion.
   * @param peticion peticion.
   * @return RespuestaFirmaFichero datos de respuesta con la firma.
   * @throws MPTFirmaException la excepcion.
   */
