 ...
 *
 */
public class UtilidadesTestEeutilFirma implements IPruebaTraza {
  protected static final Log logger = LogFactory.getLog(UtilidadesTestEeutilFirma.class);
  ...
  public String testTrazaImp() {
    ...
    logger.error("Is implementation SLF4JLocationAwareLog " + bImpSLF4JLocationAwareLog
        ...
        + " Verificacion de que la traza en eeutil-firma es correcta");
