...
public class DatosSalida {
  ...
  private static final String RES_OK_DES = "Ejecucion de firma correcta.";
  private static final String RES_ER_DES = "Error en la ejecucion de la firma.";
  ...
  public DatosSalida(String cadena) {
    ...
    if (RES_OK.equals(cadena))
      this.resultado = RES_OK_DES;
    else
      this.resultado = RES_ER_DES;
  }
